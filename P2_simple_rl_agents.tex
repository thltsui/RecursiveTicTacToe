...
\emph{Theory: \href{essay1b_rl_background.md}{T2 --- The RL Landscape}
explains TD learning, Q-learning, and the credit-assignment problem that
motivates what comes next. \href{essay1c_bandits_mcts_intro.md}{T3 ---
From Bandits to Trees} covers the UCB and PUCT theory that P3
implements.}
