...
This is everything the MCTS and training loop need from the game engine: the state representation, legal move generation, win detection, and state transitions are all in place.

---

*Theory: [From Zero to AlphaZero: Ultimate Tic-Tac-Toe](https://tthl.substack.com/p/from-zero-to-alphazero-ultimate-tic) covers the rules and strategic structure of the game. [From Zero to AlphaZero: The Reinforcement Learning Landscape](https://tthl.substack.com/p/from-zero-to-alphazero-the-reinforcement) covers the learning algorithms implemented in later posts.*

---

*Full notebook: [Notebook 1 — The UTTT Game Engine](https://colab.research.google.com/github/thltsui/RecursiveTicTacToe/blob/Substack/substack/notebook_1_uttt_engine.ipynb) — runs all the code in this post with additional tests, an ASCII board visualiser, and a random-agent tournament.*
