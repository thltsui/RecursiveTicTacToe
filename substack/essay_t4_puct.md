# T4: From Slot Machines to Game Trees — The PUCT Formula
...
*Next: T5 follows a single MCTS simulation from root to leaf — the four phases of select, expand, evaluate, and backup — and shows how running hundreds of these builds the visit-count distribution that determines which move AlphaZero plays.*
